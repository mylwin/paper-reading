...
> **后续联读已单独成文：** [ℓp 范数三篇联读：从算子界到复杂度插值](../../../07-research/2026-09-23-lp范数三篇联读_从算子界到复杂度插值.md) 补出了本节没有的 $1+\beta = \frac{p}{p-1}$ 对偶指数恒等式、$q \in [1,2]$ 复杂度插值表和主张—证据矩阵。两份文档结论互补，修订时须同步。
